        ...
        <div css={styles.leftContainer}>
          <div css={styles.listBox}>
            ...
            <div css={styles.btnContainer}>
              ...
              <div css={styles.w170}>
                <RoomMainButton title='관전모드' color='purple' />
              </div>
              <div css={styles.w170}>
          ...
          <div css={styles.bottomContainer}>
            <div css={styles.chatBox}>
              <div css={styles.chatContainer}>
                <p css={[styles.chatP, css({ opacity: 1, color: "#00e5ff" })]}>
                  [환영] 환영합니다.
                </p>
                <p css={styles.chatP}>백설하 : 안녕하세요.</p>
                <p css={styles.chatP}>코딩만랩 : 길드 들어가고 싶어요!</p>
                <p css={[styles.chatP, css({ opacity: 1 })]}>
                  킵고잉(나) : 온리메타 자율학습단 길드를 개설했어요! 많이
                  들어오세요
                </p>
                <p css={styles.chatP}>핑구돌핀 : 저 들어갈래요!</p>
                <p css={styles.chatP}>로제타 : ChatGPT 같이 배우실분?</p>
                <p css={styles.chatP}>핑구돌핀 : 저 들어갈래요!</p>
                <p css={styles.chatP}>로제타 : ChatGPT 같이 배우실분?</p>
                <p css={styles.chatP}>핑구돌핀 : 저 들어갈래요!</p>
                <p css={styles.chatP}>로제타 : ChatGPT 같이 배우실분?</p>
              ...
              <div css={styles.contentBox}>
                <div css={styles.contentContainerQuestion}>
                  {QUESTIONS.map((data, index) => (
                    <QuestionCard key={index} data={data} index={index} />
                  ))}
                </div>
              </div>
            </div>
            <div css={styles.rightContentBox}>
              ...
              <div css={styles.contentBox}>
                <div>
                  ...
                  >
                    <h4 className='title' css={styles.title}>
                      제한시간
                    </h4>
                    <div className='inputBox' css={styles.inputBox}>
                      <input
                        type='text'
                        className='timeInput'
                  ...
                  <div className='inputContainer' css={styles.inputContainer}>
                    <h4 className='title' css={styles.title}>
                      아이템
                    </h4>
                    <div className='inputBox' css={styles.inputBox}>
                      ...
                      >
                        <CheckBox
                          isCheck={isItemCheck === true}
                          handleToggleCheck={handleToggleItemCheckOn}
                        >
                          <h5>ON</h5>
                        </CheckBox>
                        <CheckBox
                          isCheck={isItemCheck === false}
                          handleToggleCheck={handleToggleItemCheckOff}
                        >
                          <h5>OFF</h5>
                        </CheckBox>
                      </div>
                  ...
                  <div className='inputContainer' css={styles.inputContainer}>
                    ...
                    <div className='inputBox' css={styles.inputBox}>
                      ...
                      >
                        <CheckBox
                          isCheck={isNpcCheck === true}
                          handleToggleCheck={handleToggleNpcCheckOn}
                        >
                          <h5>ON</h5>
                        </CheckBox>
                        <CheckBox
                          isCheck={isNpcCheck === false}
                          handleToggleCheck={handleToggleNpcCheckOff}
                        >
                          OFF
                        </CheckBox>
                      </div>
                  ...
                  <button className='detailOption' css={styles.detailOption}>
                    상세 옵션
                  </button>
                </div>
              </div>
